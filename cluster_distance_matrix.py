...
img_list = pickle.load(open('/Users/michaeldoron/makers/NLI/NLIhackton2107/map_image_list.pickle','rb'))[1:]
fig, ax = plt.subplots(figsize=(10,10))
artists = []
for image_ind in range(len(img_list)):
	im = OffsetImage(plt.imread('maps/{}'.format(img_list[image_ind])), zoom=0.03)
...
ax.xaxis.set_ticks([])
ax.yaxis.set_ticks([])
plt.savefig('maps_small.pdf', transparent=True, bbox_inches='tight', format='pdf', dpi=300)
